...
public class HullSlot : MonoBehaviour {
	...
	public static Vector3 getSlotPosition (HullType hullType, string slotName) {
		...
		switch (slotName) {
			case "HullSlot Radar": return vectors[0];
			case "HullSlot Engine": return vectors[1];
			case "HullSlot Generator 1": return vectors[2];
			case "HullSlot Generator 2": return vectors[3];
			case "HullSlot Generator 3": return vectors[4];
			case "HullSlot Harvester 1": return vectors[5];
			case "HullSlot Harvester 2": return vectors[6];
			case "HullSlot RepairDroid 1": return vectors[7];
			case "HullSlot RepairDroid 2": return vectors[8];
			case "HullSlot RepairDroid 3": return vectors[9];
			case "HullSlot RepairDroid 4": return vectors[10];
			case "HullSlot Shield 1": return vectors[11];
			case "HullSlot Shield 2": return vectors[12];
			case "HullSlot Shield 3": return vectors[13];
			case "HullSlot Weapon 1": return vectors[14];
			case "HullSlot Weapon 2": return vectors[15];
			case "HullSlot Weapon 3": return vectors[16];
			case "HullSlot Weapon 4": return vectors[17];
			case "HullSlot Weapon 5": return vectors[18];
			case "HullSlot Armor 1": return vectors[19];
			case "HullSlot Armor 2": return vectors[20];
			case "HullSlot Armor 3": return vectors[21];
			case "HullSlot Armor 4": return vectors[22];
			case "HullSlot Armor 5": return vectors[23];
	...
	public static bool checkSlotAvailability (HullType hullType, string slotName) {
		...
		switch (slotName) {
			case "HullSlot Radar": return avails[0];
			case "HullSlot Engine": return avails[1];
			case "HullSlot Generator 1": return avails[2];
			case "HullSlot Generator 2": return avails[3];
			case "HullSlot Generator 3": return avails[4];
			case "HullSlot Harvester 1": return avails[5];
			case "HullSlot Harvester 2": return avails[6];
			case "HullSlot RepairDroid 1": return avails[7];
			case "HullSlot RepairDroid 2": return avails[8];
			case "HullSlot RepairDroid 3": return avails[9];
			case "HullSlot RepairDroid 4": return avails[10];
			case "HullSlot Shield 1": return avails[11];
			case "HullSlot Shield 2": return avails[12];
			case "HullSlot Shield 3": return avails[13];
			case "HullSlot Weapon 1": return avails[14];
			case "HullSlot Weapon 2": return avails[15];
			case "HullSlot Weapon 3": return avails[16];
			case "HullSlot Weapon 4": return avails[17];
			case "HullSlot Weapon 5": return avails[18];
			case "HullSlot Armor 1": return avails[19];
			case "HullSlot Armor 2": return avails[20];
			case "HullSlot Armor 3": return avails[21];
			case "HullSlot Armor 4": return avails[22];
			case "HullSlot Armor 5": return avails[23];
